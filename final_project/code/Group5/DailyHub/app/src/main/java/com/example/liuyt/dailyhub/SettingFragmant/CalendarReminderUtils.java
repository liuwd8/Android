...
public class CalendarReminderUtils {
    ...
    private static String CALENDARS_NAME = "DailyHub";
    private static String CALENDARS_ACCOUNT_NAME = "DailyHub";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.DailyHub";
    private static String CALENDARS_DISPLAY_NAME = "DailyHub";
    ...
    public static void addCalendarEvent(Context context, String title, String description, long reminderTime, int previousDate) {
        ...
        event.put(CalendarContract.Events.EVENT_LOCATION, "来自DailyHub的提醒");
    ...
    public static boolean findCalendarEvent(Context context,String title){
        if (context == null) {
            return false;
        }
        Cursor eventCursor = context.getContentResolver().query(Uri.parse(CALENDER_EVENT_URL), null, null, null, null);
